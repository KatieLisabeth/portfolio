import icon17 from './icons/D3.svg'
import icon1 from './icons/api.svg'
import icon2 from './icons/bootstrap.svg'
...
import icon8 from './icons/next.svg'
import icon9 from './icons/nmp.svg'
import icon12 from './icons/node.svg'
import icon14 from './icons/postman.svg'
